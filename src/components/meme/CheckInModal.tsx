...
const CheckInModal = (props: any) => {
  ...
  function getNftTip() {
    ...
    <div class="flex flex-col gap-2 items-start w-80 xsm:w-72 text-left">
      ...
      <div class="flex items-start gap-1.5">
        <span class="relative top-1.5 w-1 h-1 rounded-full bg-white flex-shrink-0"></span>
        <span>Unlock MEME Honorary NFT 8 for all users in MEME Season 8 by completing tasks.</span>
      </div>
      <div class="flex items-start gap-1.5">
        <span class="relative top-1.5 w-1 h-1 rounded-full bg-white flex-shrink-0"></span>
      ...
      <div class="flex items-start gap-1.5">
        <span class="relative top-1.5 w-1 h-1 rounded-full bg-white flex-shrink-0"></span>
        <span>Holders of MEME Honorary NFT can accelerate MEME token acquisition and participate in Season 8 staking.</span>
      </div>
      <div class="flex items-start gap-1.5">
        <span class="relative top-1.5 w-1 h-1 rounded-full bg-white flex-shrink-0"></span>
